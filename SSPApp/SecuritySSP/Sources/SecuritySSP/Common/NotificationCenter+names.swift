...
public typealias Async = DispatchQueue
public extension Async {
    
    public static func main(after: TimeInterval?, _ block: () -> ()) {
        let time: TimeInterval = after ?? 0.0
    ...
    public static func mainNowOrAsync(after: TimeInterval? = nil, block: @escaping ()->()) {
